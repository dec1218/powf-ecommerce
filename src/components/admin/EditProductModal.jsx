...
import { uploadMultipleImages, deleteMultipleImages } from '../../lib/uploadHelpers'
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  {existingImages.map((imageUrl, index) => (
                    <div
                      key={`existing-${index}`}
                      className="aspect-square border-2 border-amber-300 rounded-lg flex items-center justify-center bg-amber-50 relative overflow-hidden"
                    >
                      <img
                        src={imageUrl}
                  ...
                  {imagePreviews.map((preview, index) => (
                    <div
                      key={`new-${index}`}
                      className="aspect-square border-2 border-green-400 rounded-lg flex items-center justify-center bg-green-50 relative overflow-hidden"
                    >
                      <img
                        src={preview}
                        alt={`New ${index + 1}`}
                  ...
                  {totalImages < 3 && (
                    <div className="aspect-square border-2 border-dashed border-amber-300 rounded-lg flex items-center justify-center bg-amber-50 hover:bg-amber-100 transition-colors duration-200 cursor-pointer relative overflow-hidden">
